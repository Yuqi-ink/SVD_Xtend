...
from src.pipeline_stable_video_diffusion_re import StableVideoDiffusionPipeline_Custom
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                cond_sigmas = rand_log_normal(shape=[bsz,], loc=-3.0, scale=0.5).to(latents) # torch([1])
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if (
                        ...
                        pipeline = StableVideoDiffusionPipeline_Custom.from_pretrained(
                        ...
                        with torch.autocast(
                            ...
                            for val_img_idx in range(args.num_validation_images):
                                ...
                                video_frames = pipeline(
                                    ...
                                    load_image('demo/frame_00104.JPG').resize((args.width, args.height)),
                                    height=args.height,
                                    width=args.width,
